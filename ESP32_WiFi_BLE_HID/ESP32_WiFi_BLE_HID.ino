/*
 * ============================================
 *  ESP32 ULTIMATE HID CONTROLLER
 *  Bluetooth Keyboard+Mouse + WiFi Web Control
 * ============================================
 *  - BLE HID: Appears as keyboard+mouse on PC
 *  - WiFi AP: Phone connects & controls via web
 *  - 40+ macro commands
 *  - Full Rubber Ducky script engine
 * ============================================
 */
